...
#         [3] Display the number of passenger per gender
...
#             else:
#                 elderly += 1
#     print(f"Childrens : {children}, Adults : {adults}, Elderly : {elderly}")
#
...
def display_survivors_per_age_group():
    ...
    for record in records:
        ...
        if age < 18:
            ...
            if survived == 1:
                elderly_survivors += 1
    print(f"children : {child_survivors}/{children} , adult : {adult_survivors}/{adults} , {elderly_survivors} / {elderly}")
